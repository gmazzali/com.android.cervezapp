...
public class UsuarioDataBaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
			...
			+ CAMPO_USER + " text not null," + CAMPO_APELLIDO
			+ " text not null," + CAMPO_NOMBRE + " text not null," + CAMPO_SEXO
			+ " text not null," + CAMPO_FECHA_NACIMIENTO + " text not null,"
			+ CAMPO_EMAIL + " text," + CAMPO_TELEFONO + " text, "
			+ CAMPO_FUMADOR + " integer, " + CAMPO_FOTO + " blob)";
